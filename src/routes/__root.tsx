    ...
    scripts: [
      {
        ...
        children: `!function(){var t=localStorage.getItem("theme"),e="system"===t||!t?window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light":t;document.documentElement.classList.add(e)}();`,
      },
      {
